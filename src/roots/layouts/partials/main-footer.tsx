    ...
    <footer className=" bg-[#1a1a1a]  text-gray-100 pb-16 pt-10 px-2 md:px-10">
      <div className="container mx-auto px-4">
            ...
            <ul className="space-y-3">
              ...
              >
                <button
                  ...
                  className="inline-flex items-center bg-red-500 hover:bg-red-600 text-white font-semibold px-6 py-4 rounded-lg transition duration-300 mt-4 gap-2 cursor-pointer w-full lg:w-fit"
                >
        ...
        <div className="mt-12 pt-8 border-t border-[#1a1a1a] text-center">
          ...
          {isMobile() && (
            <p className="text-gray-400 text-sm">
              Phiên bản hiện tại : {versionAppCurrent}
            </p>
          )}
        </div>
      </div>
